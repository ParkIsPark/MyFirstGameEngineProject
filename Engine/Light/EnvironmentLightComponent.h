...
public:
    ...
    float     timeOfDay    = 12.0f;                           // hour 0..24 (sun position); 12 = noon
    ...
    // color/intensity (0/24 = midnight, ~7 = sunrise, 12 = noon, ~17 = sunset).
    static void applyTimeOfDay(EnvironmentLightComponent& light, float hour);
};
